      ...
      <nav className={`z-50  flex bg-zinc-900 text-white px-8 lg:px-16 md:px-10 py-2 items-center justify-between  top-0
        ...
        <div className='nav-bookblock heaven md:flex  block items-center gap-4 '>
          <div className='hidden md:flex gap-4'>
            ...
            {items.titel === "Profile"  ? <Link to={items.link}
          ...
          </div >
          {
            ...
            <Link to="/signup" className='hover:bg-[#000000de] bg-[#ff4452] px-4 py-1 hover:border-[#ff4455] hover:border   rounded-md transition-all duration-300 hover:shadow-slate-100 hover:shadow-sm '>SignUp</Link>
