...
const ViewBookDetails = () => {
  ...
  return (
    <>
      {Data && (
        <div className="md:px-10 px-2 py-8 bg-zinc-900  flex  md:flex-row flex-col  h-auto   ">
          <div className="  lg:w-2/5 md:w-full w-2/3 m-auto    ">
            <div className=" justify-around flex bg-zinc-800 rounded  px-9  md:py-16 py-8 ">
              <img
                src={Data.url}
                alt=" Book Image"
                className="lg:h-[66vh] md:h-[30vh] h-[30vh] rounded"
              />
              ...
              {isLoggedIn === true && role === "admin" && (
                <div className="flex flex-col items-center  w-10">
                  <Link
                    to={`/updatebook/${id}`}
                    className="  p-2 bg-white  rounded-full  md:text-xl text-base lg:text-3xl lg:hover:text-4xl md:hover:text-3xl hover:text-xl hover:text-blue-500  text-black  transition-all duration-500 text-center  hover:shadow-md hover:shadow-slate-50  "
                  >
                    <FaEdit />
                  </Link>
                  <button
                    className="  p-2 bg-white rounded-full  md:text-lg text-base lg:text-3xl lg:hover:text-4xl mt-4 md:hover:text-3xl hover:text-xl hover:text-red-500 text-black  transition-all duration-500 text-center  hover:shadow-md hover:shadow-slate-50"
                    onClick={deletebook}
                  >
                    <RiDeleteBin5Fill />
                  </button>
